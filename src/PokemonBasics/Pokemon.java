...
import Templates.TemplatePokemon;
...
public class Pokemon {
    ...
    public Pokemon(int dexNumber, int level, int move1, int move2, int move3, int move4, Item item, boolean isShiny){
    ...
    public Pokemon(String nickname, int dexNumber, int level, int move1, int move2, int move3, int move4, Item item, boolean isShiny){
